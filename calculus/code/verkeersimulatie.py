...
print('minSpeed car 1: ' + str(minSpeedCar1 * 36))
print('maxSpeed car 2: ' + str(maxSpeedCar1 * 36))
print('minSpeed car 1: ' + str(minSpeedCar2 * 36))
print('maxSpeed car 2: ' + str(maxSpeedCar2 * 36))
